...
/* ============================================================
   ADMIN APP
   ============================================================ */
function AdminApp({ lang, menu, setMenu, promotions, setPromotions, banners, setBanners, orders, setOrders, updateOrderStatus, verifySlip, members, setMembers, qrImage, setQrImage, settings, setSettings }) {
  const t = T[lang];
  ...
  return (
    <div style={{ display: "flex", height: "100%" }}>
      ...
      <div className="ev-scroll" style={{ flex: 1, padding: 22 }}>
        ...
        {tab === "orders" && <OrdersTab t={t} lang={lang} orders={orders} updateOrderStatus={updateOrderStatus} verifySlip={verifySlip} />}
        {tab === "kitchen" && <KitchenTab t={t} lang={lang} orders={orders} updateOrderStatus={updateOrderStatus} verifySlip={verifySlip} />}
        ...
        {tab === "banner" && <BannerTab t={t} lang={lang} banners={banners} setBanners={setBanners} />}
        {tab === "members" && <MembersTab t={t} lang={lang} members={members} setMembers={setMembers} orders={orders} />}
        {tab === "settings" && <SettingsTab t={t} lang={lang} settings={settings} setSettings={setSettings} qrImage={qrImage} setQrImage={setQrImage} />}
