...
const T = {
  th: {
    brand: "EVEFEE",
    tagline: "Good day starts with EVEFEE",
    nav_home: "หน้าแรก",
    nav_menu: "เมนู",
    nav_cart: "ตะกร้า",
    nav_history: "ประวัติ",
    nav_track: "ติดตามออเดอร์",
    admin_login_title: "เข้าสู่ระบบร้านค้า",
    email: "อีเมล",
    password: "รหัสผ่าน",
    login: "เข้าสู่ระบบ",
    login_error: "อีเมลหรือรหัสผ่านไม่ถูกต้อง",
    bestseller: "เมนูแนะนำ",
    categories: "หมวดหมู่",
    search_ph: "ค้นหาเมนู...",
    ...
    addons: "เพิ่มเติม",
    note: "หมายเหตุ",
    note_ph: "เช่น หวานน้อย ไม่ใส่วิป",
    qty: "จำนวน",
    hot: "ร้อน",
    iced: "เย็น",
    frappe: "ปั่น",
    ...
    ice_less: "น้อย",
    ice_none: "ไม่ใส่",
    cart_title: "ตะกร้าของฉัน",
    cart_empty: "ยังไม่มีสินค้าในตะกร้า",
    go_menu: "ไปเลือกเมนู",
    total: "รวมทั้งหมด",
    checkout: "ดำเนินการสั่งซื้อ",
    coupon_ph: "ใส่โค้ดคูปอง",
    apply: "ใช้โค้ด",
    coupon_invalid: "ไม่พบคูปองนี้",
    coupon_applied: "ใช้คูปองแล้ว",
    discount: "ส่วนลด",
    checkout_title: "ยืนยันคำสั่งซื้อ",
    fulfil: "รับสินค้าแบบไหน",
    pickup: "รับที่ร้าน",
    delivery: "จัดส่ง",
    ...
    cash: "เงินสด",
    name: "ชื่อผู้สั่ง",
    phone: "เบอร์โทร (ใช้ค้นหาประวัติ)",
    address: "ที่อยู่จัดส่ง",
    place_order: "ยืนยันสั่งซื้อ",
    order_placed: "สั่งซื้อเรียบร้อยแล้ว!",
    order_no: "หมายเลขคำสั่งซื้อ",
    track_this: "ติดตามคำสั่งซื้อ",
    loading: "กำลังโหลด...",
  ...
  en: {
    ...
    admin_login_title: "Store Sign In",
    email: "Email",
    password: "Password",
    login: "Sign In",
    ...
    addons: "Add-ons",
    note: "Note",
    note_ph: "e.g. less sweet, no whip",
    qty: "Quantity",
    hot: "Hot",
    iced: "Ice",
    frappe: "Frappe",
    ...
    pickup: "Pickup",
    delivery: "Delivery",
    delivery_provider: "Delivery Partner",
    when: "Timing",
    now_order: "Order Now",
    schedule: "Schedule",
    ...
    cash: "Cash",
    name: "Your Name",
    phone: "Phone (for order history)",
    address: "Delivery Address",
    place_order: "Place Order",
    order_placed: "Order Placed!",
    order_no: "Order No.",
    track_this: "Track This Order",
    ...
    enter_order_id: "Enter order number",
    track_btn: "Search",
...
const DEFAULT_MENU = [
  { id: "c1", cat: "coffee", nameTh: "อเมริกาโน่มะพร้าว", nameEn: "Coconut Americano", price: 40, colors: ["#c9a876", "#2b1810"], temps: ["hot", "iced"], sweetAdjustable: true, iceAdjustable: true, recommended: true },
